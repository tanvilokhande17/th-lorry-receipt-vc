...
function PolicyDocument({ }) {
  ...
  return (
    <div style={{ flexDirection: "row", backgroundColor: "#d3d7dc" }}>
      ...
      <ol className="ol-text">
        ...
        <li className="p-text">During verification, driver also need to face police harassment, fake government officials as verifier, false freight claims and <span style={{ fontFamily: "Calibri" }}>out of state transportation verification issues.</span></li>
      </ol>
      ...
      <p><center><span style={{flex: 5}}>
        <img style={{marginBottom : "50px"}} className="" src={flow} />
      </span></center></p>
    </div>
  );
}
